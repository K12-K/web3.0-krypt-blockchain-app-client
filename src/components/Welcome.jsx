        ...
        <div className='flex w-full justify-center items-center'>
            <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
                <div className='flex flex-1 justify-start flex-col mf:mr-10'>
                    ...
                    <div className='grid sm:grid-cols-3 grid-cols-2 w-full mt-10 text-white'>
                ...
                <div className='flex fle-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
                    <div className='p-3 justify-end items-start flex-col rounded-x1 h-40 s,:w-72 w-full my-5 eth-card white-glassmorpism'>
